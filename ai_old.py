...
Uses OpenAI v0.28.0 API style for better compatibility with Raspberry Pi.
...
def generate_poem(
    image_path: str,
    system_prompt: str,
    model: str = "gpt-4-vision-preview",  # Use vision model compatible with v0.28.0
    max_tokens: int = 300
) -> str:
    """
    ...
    # Create the messages array for the old API style
    messages = [
        {
            "role": "system",
